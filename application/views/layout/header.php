        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">Apotek Meloxicam</a>
                </div>
				...
				<?php
                    ...
                    <li class="dropdown navbar-inverse">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            <li>
                                <a class="dropdown-item"  href="<?= site_url('view/profil/vw_profil/') ?>">
            ...
            ?>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('Obat/') ?>">
